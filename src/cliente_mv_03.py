...
IP_SERVIDOR = "127.0.0.3"  # Nueva IP de prueba
PUERTO = 5000
ID_DISPOSITIVO = "GPS-MOVIL-03"  # Nuevo ID
...
def iniciar_cliente():
    ...
    latitud = 40.7128    # Nueva coordenada inicial (ejemplo: Nueva York)
    longitud = -74.0060
    bateria = 85          # Nivel inicial distinto
